    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-green-50 py-8 md:py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-green-600 to-emerald-700 rounded-2xl p-8 md:p-12 text-white shadow-xl">
            <h3 className="text-2xl md:text-3xl font-bold mb-4">
              Ready to Experience Quality Farming?
            </h3>
            <p className="text-green-100 mb-8 max-w-2xl mx-auto">
              Join hundreds of satisfied farmers who trust Kuntal Agro Expert
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white text-green-700 font-bold px-8 py-3 rounded-full hover:bg-gray-100 transition-all duration-300">
                Visit Our Store
              </button>
              <button className="bg-green-800 text-white font-bold px-8 py-3 rounded-full hover:bg-green-900 transition-all duration-300">
                Get Expert Advice
              </button>
            </div>
          </div>
