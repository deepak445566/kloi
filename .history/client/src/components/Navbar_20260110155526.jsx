      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            >
              <div className="bg-gradient-to-br from-green-600 to-emerald-700 w-10 h-10 rounded-xl flex items-center justify-center shadow-lg">
            ...
            {/* Desktop Menu */}
            <div className="hidden lg:flex items-center space-x-5 ml-20">
              <NavLink 
                to="/" 
