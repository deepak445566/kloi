          ...
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <div className="flex flex-col">
                <span className="text-xl lg:text-2xl font-bold text-gray-900">Kuntal</span>
                <span className="text-lg lg:text-xl font-semibold text-green-700 -mt-1">Agro Agencies</span>
              </div>
            </NavLink>
