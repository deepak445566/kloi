...
import { Truck, Package, ShoppingBag, CreditCard, MapPin, User, CheckCircle, MessageCircle, Wallet, ChevronDown, ChevronUp } from 'lucide-react';
          ...
          {paymentMethod === 'cod' && (
            <div className="mb-6 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-sm text-yellow-700">
                💡 <strong>Note:</strong> For COD orders, you'll pay when the order is delivered. 
                No transaction ID is required upfront.
              </p>
            </div>
          )}
