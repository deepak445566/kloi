...
import { Truck, CheckCircle, Package, MapPin, User } from 'lucide-react';
      ...
      <div className="flex flex-col items-center justify-center min-h-[70vh] p-6">
        <div className="max-w-md w-full bg-white rounded-xl shadow-lg p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            Your order has been placed successfully. Order details have been sent to the seller.
          </p>
          ...
          <button
            ...
            className="w-full py-3 bg-primary text-white rounded-lg font-medium hover:bg-primary-dull transition"
          >
            View My Orders
          </button>
          ...
          <button
            ...
            className="w-full py-3 mt-3 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition"
          >
            Continue Shopping
          </button>
        </div>
