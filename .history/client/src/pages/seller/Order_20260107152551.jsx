...
import { 
  ...
  Globe, Map, Navigation, Pin, Target, Compass
} from 'lucide-react';
    ...
    return (
      <div className='no-scrollbar flex-1 h-[95vh] overflow-y-scroll'>
        <div className="md:p-10 p-4 space-y-4">
          <h2 className="text-lg font-medium">Loading Orders...</h2>
                  ...
                  <div className="p-4">
                    ...
                    <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-gray-600">Pincode: {selectedOrder.address.zipcode}</p>
              ...
              <div className="bg-white rounded-lg border">
                ...
                <div className="p-4">
                  <div className="flex flex-wrap gap-3">
                    <button
                      onClick={() => {
                        axios.get(`/api/order/whatsapp/${selectedOrder._id}`)
                          .then(({ data }) => {
                            if (data.success) {
                    ...
                    {selectedOrder.labelUrl && (
                      <button
                        onClick={() => downloadLabel(selectedOrder.labelUrl)}
